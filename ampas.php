...
<head>
    ...
    <title>Shell Backdoor V1.0</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
    <link rel="icon" type="image/x-icon" href="https://i.ibb.co/tcgYnYs/20230813-112453-removebg-preview.png">
...
<body>
    ...
    <div class="container">
        <section id="Header">
            <img src="https://i.ibb.co/gSzXMg5/20230813-111006.jpg" class="img-fluid rounded mx-auto d-block mb-4"
                alt="LogoBanner">
        ...
        <footer>
            <p class="text-center">© 2023 Copyright Ren7_</p>
        </footer>
